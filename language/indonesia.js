exports.noToken = "Token del bot no puede estar vacío, por favor crea el bot a través de https://t.me/BotFather"

exports.first_chat = (botname, pushname) => {
    return `¡Hola ${pushname}! Mi nombre es ${botname} - Soy un bot de Telegram multifunción. Haz clic en /menu para obtener más información sobre cómo usar este bot.

Únete a [mi canal](https://t.me/) para recibir información sobre todas las actualizaciones más recientes.

Envía el comando /privacy para ver los términos y condiciones de uso del bot.
`
}
exports.snk = "Términos y Condiciones del Bot\n\n\
1. Uso del Bot: El bot está destinado a proporcionar información y asistencia. No debe ser utilizado para actividades ilegales o no éticas.\n\
2. Privacidad: El bot respeta la privacidad del usuario y no recopila ni comparte datos personales sin el consentimiento explícito del usuario.\n\
3. Responsabilidad: Los desarrolladores del bot no se hacen responsables de cualquier daño o pérdida causada por el uso o mal uso del bot.\n\
4. Cambios en los Términos: Los términos y condiciones pueden ser actualizados en cualquier momento, y es responsabilidad del usuario revisarlos regularmente." 
exports.getStyle = (style, style2) => {
    return `**El ${style2} que ingresaste es incorrecto**\n\n__Aquí está la lista correcta de ${style2}, el total es__ **${style}** __${style2}__\n\n`
}
exports.wait = "`⏳ Por favor, espera un momento.`"
exports.ok = `listo ✅`
exports.menu = async (alpha, thumbnail, pushname, OWNER_NAME, OWNER, prefix, hitall, latensii, os, simple, week, date, dateIslamic, username, isCreator, user_id) => {
    var ini_anu = `╭─❒ 「 Hola ${pushname}! 」
├ 
├ ╭─❒「 Información del Bot 🤖」 
├ │ Creador: [@${OWNER_NAME}](${OWNER[0]})
├ │ Patrocinador: [@BotFather](https://t.me/BotFather)
├ │ Prefijo: ${prefix}
├ │ Total de visitas: ${hitall}
├ │ Velocidad: ${latensii.toFixed(4)} segundos
├ │ Memoria: ${(process.memoryUsage().heapUsed / 1024 / 1024).toFixed(2)}MB / ${Math.round(require('os').totalmem / 1024 / 1024)}MB
├ │ Host: ${os.hostname()}
├ │ Plataforma: ${os.platform()}
├ ╰❒ Tiempo activo: ${simple.runtime(process.uptime())}
├
...
├ │Nombre: ${pushname}
├ │ Usuario: [@${pushname}](https://t.me/${username})
├ ╰❒ Propietario: ${isCreator ? 'Sí ✅' : 'No ❌'}
╰❒
`
    var button = [
        [{
